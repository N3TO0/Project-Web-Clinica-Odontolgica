...
SECRET_KEY = 'django-insecure-+vy4#!t^8*5+b5_(3*1e6q=@8oj0#wb!$es#d_$iz2&w584%mg'
...
#DATABASES = {
#   'default': {
#        'ENGINE': 'django.db.backends.mysql',  # Alterado para usar MySQL
#        'NAME': 'bd_clinicas',                  # Nome do seu banco de dados
